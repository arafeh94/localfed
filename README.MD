...
data differently before even starting with federated learning. To get the idea, support that we are working on mnist
data. Using federated learning, we should test the model creation under these scenarios:
