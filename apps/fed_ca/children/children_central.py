...
client_data = PickleDataProvider("../../../datasets/pickles/children_touch.pkl").collect()
...
train = PickleDataProvider(generated_filename).collect()
...
for model_name, gen_model in initial_models.items():
    ...
    for config in configs:
        ...
        for i in range(num_rounds):
            ...
            acc, loss = tools.infer(gen_model, train.batch(batch_size))
            print(acc, loss, i + 1)
