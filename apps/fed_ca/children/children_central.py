...
train_data, test_data = all_data.reduce(lambdas.dict2dc).shuffle(47).as_tensor().split(0.8)
#
...
for model_name, gen_model in initial_models.items():
    hyper_params = {'batch_size': [1024], 'epochs': [5], 'num_rounds': [200], 'learn_rate': [0.1]}
