...
all_data = preload('mnist', distributor=UniqueDistributor(max_clients, 1500, 1500))

clients_data = all_data.map(lambdas.dc_split(0.2, 1))

test_data = all_data.map(lambdas.dc_split(0.2, 0))
