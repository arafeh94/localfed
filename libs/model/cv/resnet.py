...
def resnet56_test(class_num, channels: int, xy_size: int, pretrained=False, path=None, **kwargs):
    """
    Constructs a ResNet-110 model.
...
class CNN_batch_norm_cifar10(nn.Module):
    """CNN."""

    def __init__(self):
        """CNN Builder."""
        super(CNN_batch_norm_cifar10, self).__init__()
