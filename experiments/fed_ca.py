...
from src.apis.hp_generator import generate_configs, build_grid
...
configs = generate_configs(build_grid(batch_size=(5, 128, 5), epochs=(5, 100, 5), num_rounds=(5, 120, 10)))
runs = {}
