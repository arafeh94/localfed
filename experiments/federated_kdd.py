...
from src.data.data_provider import PickleDataProvider, LocalMnistDataProvider, LocalKDDDataProvider
...
trainer_manager = TrainerManager(trainers.CPUTrainer, batch_size=50, epochs=10, criterion=nn.CrossEntropyLoss(),
